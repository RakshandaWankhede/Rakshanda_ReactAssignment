    ...
    render(){
      return (
        <div className="HomePage">
          { this.state.products.length > 0 ? <Carousel products={this.state.products}/>:null}
        </div>
      );
    }
  }
